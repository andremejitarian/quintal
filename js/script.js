...
$(document).ready(function () {
    ...
    function updatePaymentMethodDescription(method) {
        ...
        if (planKey === 'experimental' || planKey === 'avulso' || planKey === '4_aulas' || planKey === '8_aulas') {
            ...
            description = 'A assinatura será cobrada no dia 5 de cada mês. A primeira cobrança será referente ao valor proporcional dos dias restantes do mês da inscrição';
        }
